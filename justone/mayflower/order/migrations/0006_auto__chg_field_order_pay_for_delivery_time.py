...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.pay_for_delivery_time'
        db.alter_column(u'order_order', 'pay_for_delivery_time', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Order.pay_for_delivery_time'
        db.alter_column(u'order_order', 'pay_for_delivery_time', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
