...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basket.product_price_type'
        db.add_column(u'order_basket', 'product_price_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basket.product_price_type'
        db.delete_column(u'order_basket', 'product_price_type')
    ...
    models = {
        ...
        u'order.basket': {
            ...
            'product_price_type': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
        ...
        u'order.order': {
            ...
            'pay_for_delivery_time': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
