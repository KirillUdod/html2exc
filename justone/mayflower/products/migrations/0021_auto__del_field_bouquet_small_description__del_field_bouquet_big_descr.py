...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bouquet.small_short_description'
        db.add_column(u'products_bouquet', 'small_short_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Bouquet.big_short_description'
        db.add_column(u'products_bouquet', 'big_short_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Bouquet.small_short_description'
        db.delete_column(u'products_bouquet', 'small_short_description')

        # Deleting field 'Bouquet.big_short_description'
        db.delete_column(u'products_bouquet', 'big_short_description')
    ...
    models = {
        u'products.bouquet': {
            ...
            'big_short_description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'default_price_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
            ...
            'small_short_description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
