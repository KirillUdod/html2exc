...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Unusual.small_picture'
        db.delete_column(u'products_unusual', 'small_picture')

        # Deleting field 'Bouquet.small_picture'
        db.delete_column(u'products_bouquet', 'small_picture')

        # Deleting field 'Special.small_picture'
        db.delete_column(u'products_special', 'small_picture')


    def backwards(self, orm):
        # Adding field 'Unusual.small_picture'
        db.add_column(u'products_unusual', 'small_picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Bouquet.small_picture'
        db.add_column(u'products_bouquet', 'small_picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Special.small_picture'
        db.add_column(u'products_special', 'small_picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)
