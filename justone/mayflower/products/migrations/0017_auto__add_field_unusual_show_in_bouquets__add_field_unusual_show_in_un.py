...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unusual.show_in_bouquets'
        db.add_column(u'products_unusual', 'show_in_bouquets',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unusual.show_in_unusuals'
        db.add_column(u'products_unusual', 'show_in_unusuals',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Special.show_in_bouquets'
        db.add_column(u'products_special', 'show_in_bouquets',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Special.show_in_unusuals'
        db.add_column(u'products_special', 'show_in_unusuals',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Bouquet.show_in_bouquets'
        db.add_column(u'products_bouquet', 'show_in_bouquets',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Bouquet.show_in_unusuals'
        db.add_column(u'products_bouquet', 'show_in_unusuals',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unusual.show_in_bouquets'
        db.delete_column(u'products_unusual', 'show_in_bouquets')

        # Deleting field 'Unusual.show_in_unusuals'
        db.delete_column(u'products_unusual', 'show_in_unusuals')

        # Deleting field 'Special.show_in_bouquets'
        db.delete_column(u'products_special', 'show_in_bouquets')

        # Deleting field 'Special.show_in_unusuals'
        db.delete_column(u'products_special', 'show_in_unusuals')

        # Deleting field 'Bouquet.show_in_bouquets'
        db.delete_column(u'products_bouquet', 'show_in_bouquets')

        # Deleting field 'Bouquet.show_in_unusuals'
        db.delete_column(u'products_bouquet', 'show_in_unusuals')
