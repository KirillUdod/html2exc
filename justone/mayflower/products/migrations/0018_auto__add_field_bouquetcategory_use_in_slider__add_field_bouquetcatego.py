...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BouquetCategory.use_in_slider'
        db.add_column(u'products_bouquetcategory', 'use_in_slider',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BouquetCategory.slider_photo'
        db.add_column(u'products_bouquetcategory', 'slider_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnusualCategory.use_in_slider'
        db.add_column(u'products_unusualcategory', 'use_in_slider',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UnusualCategory.slider_photo'
        db.add_column(u'products_unusualcategory', 'slider_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BouquetCategory.use_in_slider'
        db.delete_column(u'products_bouquetcategory', 'use_in_slider')

        # Deleting field 'BouquetCategory.slider_photo'
        db.delete_column(u'products_bouquetcategory', 'slider_photo')

        # Deleting field 'UnusualCategory.use_in_slider'
        db.delete_column(u'products_unusualcategory', 'use_in_slider')

        # Deleting field 'UnusualCategory.slider_photo'
        db.delete_column(u'products_unusualcategory', 'slider_photo')
