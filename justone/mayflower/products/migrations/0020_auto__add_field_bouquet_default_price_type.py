...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bouquet.default_price_type'
        db.add_column(u'products_bouquet', 'default_price_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bouquet.default_price_type'
        db.delete_column(u'products_bouquet', 'default_price_type')
    ...
    models = {
        u'products.bouquet': {
            ...
            'default_price_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10'}),
